...
const resize = () => {
  ...
  // 使用了 scale 的 echarts其实不需要重新计算缩放比例
...
const initCharts = (): void => {
  ...
  dataScreen.chart2 = MaleFemaleRatioRef.value?.initChart({
    man: 0.6,
    woman: 0.4
  }) as ECharts
  ...
  dataScreen.chart5 = AnnualUseRef.value?.initChart({
    data: annualData,
  ...
  <div class="dataScreen-container">
    <div class="dataScreen" ref="dataScreenRef">
      <div class="dataScreen-header">
        <div class="header-lf">
          <div class="header-screening" @click="($event) => router.push(HOME_URL)">首页</div>
        </div>
        <div class="header-ct">
        ...
        <div class="header-rg">
          <div class="header-download">统计报告</div>
