...
import { ElSelect, InputProps, SwitchProps, TimePickerDefaultProps } from "element-plus";
...
interface Select {
  el: "select";
  props?: Partial<typeof ElSelect._defaults>;
}
...
export type searchProps = BaseSearch & (Input | Select | DatePicker | TimePicker | Switch | TreeSelect)
